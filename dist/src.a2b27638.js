...
var score = document.querySelectorAll("#score"); // Use querySelector() to get the score element
var timerDisplay = document.querySelectorAll("#timer"); // use querySelector() to get the timer element.
 ...
 */
function showUp() {
  var delay = setDelay(); // TODO: Update so that it uses setDelay()
  var hole = chooseHole(); // TODO: Update so that it use chooseHole()
